...
model SRc2h6
  ...
  constant Types.CpCoeff1 a_i[nX] = {SD.cpC2H6mol[4], SD.cpH2Omol[4], SD.cpCOmol[4], SD.cpH2mol[4]} "a coefficient for cp for C2H6, H2O, CO, H2";
  constant Types.CpCoeff2 b_i[nX] = {SD.cpC2H6mol[3], SD.cpH2Omol[3], SD.cpCOmol[3], SD.cpH2mol[3]} "b coefficient for cp for C2H6, H2O, CO, H2";
  constant Types.CpCoeff3 c_i[nX] = {SD.cpC2H6mol[2], SD.cpH2Omol[2], SD.cpCOmol[2], SD.cpH2mol[2]} "c coefficient for cp for C2H6, H2O, CO, H2";
  constant Types.CpCoeff4 d_i[nX] = {SD.cpC2H6mol[1], SD.cpH2Omol[1], SD.cpCOmol[1], SD.cpH2mol[1]} "d coefficient for cp for C2H6, H2O, CO, H2";
  constant Types.SpecificMolarGibbsFreeEnergy dg0fTref[nX] = {SD.GfC2H6mol, SD.GfH2Omol, SD.GfCOmol, SD.GfH2mol} "Specific molar Gibbs free energy of formation";
  constant Types.SpecificMolarGibbsFreeEnergy dg0rTref = stoichCoeff*dg0fTref "Molar Gibbs free energy of reaction";
  constant Types.MolarEnthalpy dh0fTref[nX] = {SD.HfC2H6mol, SD.HfH2Omol, SD.HfCOmol, SD.HfH2mol} "Specific molar enthalpy of formation";
  ...
  constant Types.PerUnit stoichCoeff[nX] = {-1, -2, 2, 5} "Stoichiometric coefficient of the reaction";
